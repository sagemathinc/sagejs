...
- [ ] Theta series of integral quadratic forms with proved weight, level, and
  character.
- [ ] Unary theta series and the initial half-integral-weight building blocks.
- [ ] Cohen Eisenstein series or another audited construction sufficient for
  the initial half-integral-weight corpus.
- [ ] A registry of formula families recording literature/software
...
- [ ] A corpus where formulas prove only a proper subspace, exercising honest
  partial-span behavior.
- [ ] Initial half-integral-weight spaces generated by theta/Cohen formulas,
...
- [ ] Use formula-generated forms as independent oracles for modular-symbol
  ...
  coefficients.
- [ ] Let `algorithm="auto"` choose only from receipt-backed domains; explicit
...
- [ ] Cover at least one half-integral-weight space, Kohnen-relevant example,
  and formula-derived Hecke comparison without pretending modular symbols are
  the construction engine.
- [ ] Cover a formula family whose rank is strictly smaller than the ambient
...
- [ ] Detect dihedral forms and construct their Artin representations where
  supported.
- [ ] Half-integral-weight modular-form spaces and $q$-expansion bases.
- [ ] Kohnen plus and new subspaces.
- [ ] Shimura/Kohnen correspondence to integral weight.
- [ ] Hecke operators and eigenforms in half-integral weight.
