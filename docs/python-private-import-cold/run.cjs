...
if(hashes.baseline!=='9b5a78c2e5b024f0caee7ccb02f591255a7b36cf9c2cda5c288b4c5014058d12'||hashes.candidate!=='3a4f8c162b35ba63b49be64853046a74d8f2e6abbe3a0877b711e1674f5d8f3b')throw Error('wrong compiler');
const report={scope:'compiler-only cold developer experiment: identical PR263 Python compiler source, private self-build option off/on; common c4 runtime/resources; gate30s separately; fixed four non-gating90s diagnostics; no retries, not whole-build qualification',baselineCommit:'9ad99322e plus self-driver option disabled',candidateCommit:'9ad99322e',candidateBuildNode:'26.8.1',baselineBuildNode:'26.8.1',node:process.version,nodeHash:sha(process.execPath),hashes,sources,runs:[]};
