...
Input identity: `0801bc299a3db4ce16e842387efd605aeaad44d30891a8ea062b539ebcc3062d` (712 files, 14438601 bytes).
Analyzed source bundle: `sha256:f8d36746bfbe06955241b8cc1b1aa9d91e80a937b897654f6db10d12c5b2a464`; compiler identity: `sha256:ca1a3c5a7189d0bb53b5a7db3f38f18ed39475b17f2b539f62625222cab7eb7d`.
...
| Measure | Count |
| --- | ---: |
| Source modules compiled | 629 / 629 |
| Library modules compiled | 616 / 616 |
| Explicit control sources compiled | 13 / 13 |
| Functions and methods compiled | 16259 |
| Loop-bearing functions and methods | 5121 |
| Loops in functions | 14243 |
| Selected optimized loops | 55 |
| Compiler-rejected loops | 3468 |
| Unrecognized loops | 10720 |
...
- Potential object-result sites: 95200
- Collection-allocation sites: 11483
- Known coercion sites: 19718
- Potential boundary-call sites: 100
- Unresolved call sites: 48183
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 10720 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 9586 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 9057 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
| `dashboard.comprehension-loop` | 5261 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
