...
Input identity: `9d7b0bc5f8a1fe31bdcf66eb96bb776ca27397ee56437a4d1c05747cbfafba7c` (707 files, 14402460 bytes).
Analyzed source bundle: `sha256:77aab21942e17c5c2c3154ac63250df7d4beb9933733d2120ab73962034bd9f3`; compiler identity: `sha256:0cbeb975d42ea37c5de9117798d133324cc867f02050cd1f1b65dffc385ed41a`.
...
| Loop-bearing functions and methods | 5111 |
| Loops in functions | 14231 |
| Selected optimized loops | 55 |
| Compiler-rejected loops | 3468 |
| Unrecognized loops | 10708 |
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 10708 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 9574 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 9048 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
...
| `dashboard.control-flow-sites` | 2559 | Canonicalize the branches into a verified operation graph or add a domain-specific control-flow proof. |
