...
Input identity: `da9562effe91bdec6f214b87ed89e68009ace741157c2fa6209a370a01bedabc` (579 files, 11918548 bytes).
Analyzed source bundle: `sha256:5cf514ae197cdc0756d8c3a91ba3ec1e2d6ee4eb3c094e0c4b4b5256c6a29ac2`; compiler identity: `sha256:0555ddd0966aa97b27d8dfe03640f863f7e9167db11fafc46ac07ea9013f292e`.
...
| Functions and methods compiled | 14012 |
| Loop-bearing functions and methods | 4344 |
| Loops in functions | 11971 |
| Selected optimized loops | 52 |
| Compiler-rejected loops | 3017 |
| Unrecognized loops | 8902 |
...
- Potential object-result sites: 78578
- Collection-allocation sites: 9621
- Known coercion sites: 16582
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 8902 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 8006 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 7547 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
| `dashboard.comprehension-loop` | 4153 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
...
| `bounded-integer.dynamic-call` | 2405 | Inline, hoist, or batch the dynamic call so the loop is one closed exact-integer operation graph. |
...
| `bounded-integer.mutable-buffer-access` | 1756 | Prove an owner-bound packed buffer, alias discipline, and transactional publication. |
...
| `bounded-integer.unsupported-operation:+=` | 798 | Replace or prove the one unsupported exact-integer operation, then pin the bounded-integer pass. |
...
| `bounded-integer.unsupported-operation://` | 313 | Replace or prove the one unsupported exact-integer operation, then pin the bounded-integer pass. |
