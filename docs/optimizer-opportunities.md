...
Input identity: `a41eb558d6f96e8105ba826e5bbf594d29124366a1cad306de6b11284606d92c` (655 files, 13462291 bytes).
Analyzed source bundle: `sha256:521f424c38945d0352f336f769812a9b217fb5b94102d2f16deeb57aa7d9861b`; compiler identity: `sha256:2848356b2f2e7e23e3cacc64ab8e6fd716d82bad5eee825c660824f0e7d41c48`.
...
| Functions and methods compiled | 15418 |
| Loop-bearing functions and methods | 4877 |
| Loops in functions | 13456 |
| Selected optimized loops | 54 |
| Compiler-rejected loops | 3120 |
| Unrecognized loops | 10282 |
...
- Potential object-result sites: 88269
- Collection-allocation sites: 10846
- Known coercion sites: 17576
- Potential boundary-call sites: 86
- Unresolved call sites: 44957
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 10282 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 9194 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 8764 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
| `dashboard.comprehension-loop` | 5029 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
| `dashboard.indexed-access-sites` | 3687 | Prove shape, element representation, aliasing, and ownership before selecting a packed lowering. |
...
| `dashboard.control-flow-sites` | 2455 | Canonicalize the branches into a verified operation graph or add a domain-specific control-flow proof. |
