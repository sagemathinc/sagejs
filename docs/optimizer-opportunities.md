...
Input identity: `972c5a8a4e93f9021d27043b8c2105d9eba389cd105da3067e3fc4d78e96d155` (574 files, 11726447 bytes).
Analyzed source bundle: `sha256:29e15449b3b66e20a621af0f405a1a6890e2ea7df9fc8d9a8d5c289b6d0cdc62`; compiler identity: `sha256:d93d39473e65452d10e1825ca58fb2e6d7cfce439746f3266e1f6f0144b38afa`.
...
| Functions and methods compiled | 13583 |
| Loop-bearing functions and methods | 4239 |
| Loops in functions | 11725 |
| Selected optimized loops | 52 |
| Compiler-rejected loops | 2980 |
| Unrecognized loops | 8693 |
...
- Potential object-result sites: 77275
- Collection-allocation sites: 9405
- Known coercion sites: 16366
- Potential boundary-call sites: 81
- Unresolved call sites: 39208
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 8693 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 7814 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 7346 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
| `dashboard.comprehension-loop` | 4052 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
| `dashboard.indexed-access-sites` | 3025 | Prove shape, element representation, aliasing, and ownership before selecting a packed lowering. |
...
| `dashboard.control-flow-sites` | 2094 | Canonicalize the branches into a verified operation graph or add a domain-specific control-flow proof. |
| `bounded-integer.unsupported-iterator` | 1890 | Use a proved built-in `range` iteration shape or add a verifier for the required iterator semantics. |
...
| `dashboard.nested-loop-sites` | 1706 | Consider a fused multidimensional region with explicit shape and work bounds. |
...
| `bounded-integer.unsupported-operation:+=` | 789 | Replace or prove the one unsupported exact-integer operation, then pin the bounded-integer pass. |
| `bounded-integer.unsupported-operation:%` | 773 | Replace or prove the one unsupported exact-integer operation, then pin the bounded-integer pass. |
