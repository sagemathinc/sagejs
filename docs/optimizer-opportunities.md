...
Input identity: `34b81a3fff2948f8a4ca6368c7e952497a8d222b0a1c2d3ef9709be29692a012` (653 files, 13333774 bytes).
Analyzed source bundle: `sha256:5cf1593d48cb436183604a6f93fe71d9903eb208256a142e19a91849eec9ff81`; compiler identity: `sha256:51a09b3110ab836876986c76ea47f7af13906256f15ea910063d0a041267c24d`.
...
- Potential object-result sites: 87202
- Collection-allocation sites: 10680
- Known coercion sites: 17450
- Potential boundary-call sites: 81
- Unresolved call sites: 44347
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 10104 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 9037 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 8594 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
| `dashboard.comprehension-loop` | 4934 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
...
| `dashboard.control-flow-sites` | 2404 | Canonicalize the branches into a verified operation graph or add a domain-specific control-flow proof. |
| `dashboard.nested-loop-sites` | 1934 | Consider a fused multidimensional region with explicit shape and work bounds. |
