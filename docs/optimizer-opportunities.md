...
Input identity: `88485f563f32967cba55cddef5fd8275f340b0e615ebe56e077c1069599a8c4b` (512 files, 10664551 bytes).
Analyzed source bundle: `sha256:f0a99a46e833c81bc1d8950dc306646721c3d5914f66127b7260cee94d86476e`; compiler identity: `sha256:f03e87104e17b68818e5a21634f26a5b7531b3ff0a8cfa0999a4af1b29cd6eea`.
...
| Functions and methods compiled | 11641 |
| Loop-bearing functions and methods | 3693 |
| Loops in functions | 10466 |
| Selected optimized loops | 49 |
| Compiler-rejected loops | 2797 |
| Unrecognized loops | 7620 |
...
- Potential object-result sites: 70477
- Collection-allocation sites: 8428
- Known coercion sites: 15285
- Potential boundary-call sites: 72
- Unresolved call sites: 35396
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 7620 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 6839 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
...
| `dashboard.comprehension-loop` | 3577 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
| `dashboard.indexed-access-sites` | 2675 | Prove shape, element representation, aliasing, and ownership before selecting a packed lowering. |
| `bounded-integer.dynamic-call` | 2233 | Inline, hoist, or batch the dynamic call so the loop is one closed exact-integer operation graph. |
...
| `bounded-integer.unsupported-iterator` | 1774 | Use a proved built-in `range` iteration shape or add a verifier for the required iterator semantics. |
| `bounded-integer.mutable-buffer-access` | 1631 | Prove an owner-bound packed buffer, alias discipline, and transactional publication. |
