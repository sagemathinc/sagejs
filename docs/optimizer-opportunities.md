...
Input identity: `b9b723f6d9c069f395c15115de2b478f782de9f91cacb2ec7896fef35240d0b5` (574 files, 11742575 bytes).
Analyzed source bundle: `sha256:c58c93a83247e9cb4efb632c08faa07d0fa207c4d473ebb29eee91aeea15f659`; compiler identity: `sha256:7031f097abea8868f5fa7fb7fb9babc599bd08179a80b9d247197860b97c93a3`.
...
| Functions and methods compiled | 13613 |
| Loop-bearing functions and methods | 4251 |
| Loops in functions | 11771 |
| Selected optimized loops | 52 |
| Compiler-rejected loops | 2978 |
| Unrecognized loops | 8741 |
...
- Potential object-result sites: 77468
- Collection-allocation sites: 9456
- Known coercion sites: 16404
- Potential boundary-call sites: 81
- Unresolved call sites: 39320
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 8741 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 7860 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 7392 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
| `dashboard.comprehension-loop` | 4085 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
| `dashboard.indexed-access-sites` | 3049 | Prove shape, element representation, aliasing, and ownership before selecting a packed lowering. |
...
| `dashboard.control-flow-sites` | 2103 | Canonicalize the branches into a verified operation graph or add a domain-specific control-flow proof. |
...
| `dashboard.nested-loop-sites` | 1719 | Consider a fused multidimensional region with explicit shape and work bounds. |
| `bounded-integer.unsupported-operation:=` | 1499 | Replace or prove the one unsupported exact-integer operation, then pin the bounded-integer pass. |
...
| `dashboard.unsupported-while-loop` | 774 | Prove a finite progress measure and transactional exits before lowering a `while` loop. |
