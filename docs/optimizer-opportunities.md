...
Input identity: `e2c67bea3a76196d73357e485573233970277cbf14b44a370a9a8f38c1095347` (709 files, 14417696 bytes).
Analyzed source bundle: `sha256:def41821d43956324ca34f780929ed52b57ed873d754203a29b1100bbae8ad89`; compiler identity: `sha256:0cbeb975d42ea37c5de9117798d133324cc867f02050cd1f1b65dffc385ed41a`.
...
| Functions and methods compiled | 16243 |
| Loop-bearing functions and methods | 5116 |
| Loops in functions | 14235 |
| Selected optimized loops | 55 |
| Compiler-rejected loops | 3468 |
| Unrecognized loops | 10712 |
...
- Potential object-result sites: 95090
- Collection-allocation sites: 11476
- Known coercion sites: 19699
- Potential boundary-call sites: 100
- Unresolved call sites: 48124
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 10712 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 9579 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 9051 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
...
| `dashboard.indexed-access-sites` | 3811 | Prove shape, element representation, aliasing, and ownership before selecting a packed lowering. |
...
| `dashboard.control-flow-sites` | 2562 | Canonicalize the branches into a verified operation graph or add a domain-specific control-flow proof. |
