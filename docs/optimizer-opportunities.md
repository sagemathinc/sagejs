...
Input identity: `4aaa2a6f47094f949085bb5c449fb4e667509f0ce09f8cfe47675f40e929d178` (653 files, 13344830 bytes).
Analyzed source bundle: `sha256:a2941a9173df1c1800b8cb8f3db52c3624da60c9bcd941060d3fe66bfa3b75a0`; compiler identity: `sha256:51a09b3110ab836876986c76ea47f7af13906256f15ea910063d0a041267c24d`.
...
| Measure | Count |
| --- | ---: |
| Source modules compiled | 570 / 570 |
| Library modules compiled | 557 / 557 |
| Explicit control sources compiled | 13 / 13 |
| Functions and methods compiled | 15249 |
| Loop-bearing functions and methods | 4822 |
| Loops in functions | 13257 |
| Selected optimized loops | 54 |
| Compiler-rejected loops | 3093 |
| Unrecognized loops | 10110 |
...
- Potential object-result sites: 87246
- Collection-allocation sites: 10685
- Known coercion sites: 17450
- Potential boundary-call sites: 81
- Unresolved call sites: 44369
...
| --- | ---: | --- |
| `dashboard.no-current-pass-claimed` | 10110 | No existing mathematical-domain pass proves this loop; profile it before adding a new domain. |
| `dashboard.dynamic-call-sites` | 9044 | Profile the calls, then inline, hoist, batch, or give the dominant call an authenticated coarse boundary. |
| `dashboard.no-mathematical-domain-evidence` | 8600 | Add precise annotations or an explicit domain contract only after profiling proves this loop matters. |
| `dashboard.comprehension-loop` | 4938 | Lower the comprehension through a dedicated packed/container representation before scalar optimization. |
| `dashboard.indexed-access-sites` | 3616 | Prove shape, element representation, aliasing, and ownership before selecting a packed lowering. |
...
| `dashboard.control-flow-sites` | 2406 | Canonicalize the branches into a verified operation graph or add a domain-specific control-flow proof. |
| `dashboard.nested-loop-sites` | 1935 | Consider a fused multidimensional region with explicit shape and work bounds. |
