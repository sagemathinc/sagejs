...
if(hashes.baseline!=='42159115d5f2ff666423bd6c92e6781e049a98679226dc076f093754f28f8d64'||hashes.candidate!=='fe8484106aacfccec3e413d16ba2efc960a54eaf607cededd68c2f79c3240046')throw Error('wrong compiler');
const report={scope:'compiler-only cold developer experiment: c4 baseline compiler vs PR248 compiler; common c4 runtime/resources; gate30s separately; fixed four non-gating90s diagnostics; no retries, not whole-build qualification',baselineCommit:'c4c126d09ba4f5c2fb30001fd8b561b24105d80f',candidateCommit:'786d23b1b',candidateBuildNode:'26.8.1',baselineBuildNode:'26.7.0',node:process.version,nodeHash:sha(process.execPath),hashes,sources,runs:[]};
