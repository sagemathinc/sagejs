...
Source-current release qualification is intentionally pending until the
narrowed reactor passes independent review, sanitizer runs, the representative
corpus, a real Chromium worker, and all four persistent release hosts.
