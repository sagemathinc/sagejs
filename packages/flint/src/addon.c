...
static napi_value initialize(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor properties[] = {
        ...
        {"qqbarApprox", NULL, sagejs_qqbar_approx,
            NULL, NULL, NULL, napi_default, NULL},
        {"qqbarLogAbsBall", NULL, sagejs_qqbar_log_abs_ball,
            NULL, NULL, NULL, napi_default, NULL},
        {"numberFieldSplittingTypes", NULL,
            sagejs_number_field_splitting_types,
            NULL, NULL, NULL, napi_default, NULL},
        ...
        {"mpolyTotalDegree", NULL, sagejs_mpoly_total_degree,
            NULL, NULL, NULL, napi_default, NULL},
        {"mpolyLeadingMonomial", NULL, sagejs_mpoly_leading_monomial,
            NULL, NULL, NULL, napi_default, NULL},
        {"mpolyGroebner", NULL, sagejs_mpoly_groebner,
            NULL, NULL, NULL, napi_default, NULL},
        {"mpolyGroebnerMsolve", NULL, sagejs_mpoly_groebner_msolve,
            NULL, NULL, NULL, napi_default, NULL},
        ...
        {"rforestCapabilities", NULL,
            ...
            NULL, NULL, NULL, napi_default, NULL},
        {"genus3JacobianSearchProgression", NULL,
            sagejs_g3j_search_progression_value,
            NULL, NULL, NULL, napi_default, NULL},
        {"genus3JacobianScalarMultiply", NULL,
            sagejs_g3j_scalar_multiply_value,
            NULL, NULL, NULL, napi_default, NULL},
        {"genus3JacobianSum", NULL,
            sagejs_g3j_sum_value,
            NULL, NULL, NULL, napi_default, NULL},
        {"genus3JacobianCapabilities", NULL,
            sagejs_g3j_capabilities_value,
            NULL, NULL, NULL, napi_default, NULL},
        ...
        {"hyperellipticCentralWeights", NULL,
            ...
            NULL, NULL, NULL, napi_default, NULL},
        {"hyperellipticPeriodEdgeBatchArb", NULL,
            sagejs_hyperelliptic_period_edge_batch_arb,
            NULL, NULL, NULL, napi_default, NULL},
        {"hyperellipticAbelJacobiBatchArb", NULL,
            sagejs_hyperelliptic_abel_jacobi_batch_arb,
            NULL, NULL, NULL, napi_default, NULL},
        {"hyperellipticRealPeriodArb", NULL,
            sagejs_hyperelliptic_real_period_arb,
            NULL, NULL, NULL, napi_default, NULL},
