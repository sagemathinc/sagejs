...
fflas = Library(
    ...
    link_windows=[],
    dependencies=["FFLAS-FFPACK", "Givaro", "BLAS", "GMP"],
...
@fflas.function(
    dynamic="ffiFflasModularDoubleAvailable",
    symbol="sagejs_fflas_modular_double_available",
    returns=int,
    abi=[],
    effects=Effects(pure=True),
    result=Direct(),
...
@fflas.function(
    dynamic="ffiFflasModularDoubleMul",
    symbol="sagejs_fflas_modular_double_mul",
    returns=int,
    abi=[
        out(
            "output_data",
...
@fflas.function(
    dynamic="ffiFflasModularDoubleRank",
    symbol="sagejs_fflas_modular_double_rank",
    returns=int,
    abi=[
        out(
            "rank_data",
...
@fflas.function(
    dynamic="ffiFflasModularDoubleRref",
    symbol="sagejs_fflas_modular_double_rref",
    returns=int,
    abi=[
        out(
            "output_data",
...
@fflas.function(
    dynamic="ffiFflasModularDoubleRightNullspace",
    symbol="sagejs_fflas_modular_double_right_nullspace",
    returns=int,
    abi=[
        out(
            "output_data",
