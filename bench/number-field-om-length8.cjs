...
const samples = Math.max(
  1,
  Number(process.env.SAGEJS_OM_LENGTH8_SAMPLES || 1),
);
...
process.stdout.write(
  `${JSON.stringify(
    {
      schema_version: 1,
      profile: "v429-p2-f4-effective-length-eight-mixed-radix-hnf",
      samples,
      cpython,
      sagejs,
      auto_selection: false,
      proved_domain: {
        maximum_type_depth: 4,
        maximum_effective_residual_length: 8,
        maximum_refinements_per_level: 16,
      },
    },
    null,
    2,
