...
The current execution was made from committed source `4ecd5bded`. All twelve
fresh processes reached a self-sealed conditional-GRH result in 1.949 seconds
...
fields after the compact-route crossover change, improved from about 15.4.
