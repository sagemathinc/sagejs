...
repetitions = int(os.environ.get("SAGEJS_NATIVE_P1_PRODUCTION_REPETITIONS", "20"))
...
oracle = line._higher_weight_hecke_matrix_flint(weight, sign, prime, presentation)
if typed != oracle:
...
for _sample in range(samples):
    ...
    flint_samples.append((time.perf_counter_ns() - start) / repetitions)
