...
def pari_real_resize(
    ...
    """
    if target < 64 or target > 4352 or target % 64 != 0:
...
def pari_real_truncate(
    ...
    """
    if target < 64 or target > precision or precision > 4352:
...
def pari_exp1r_abs(
    ...
    limited to the coordinated 4,352-bit internal boundary, never clamped.
    """
    if precision < 64 or precision > 4352 or precision % 64 != 0:
