...
function prepareInvocation(resident) {
  ...
  const input = {
    ...
    unit_columns: 7n, unit_precision: 192n, unit_rank: 2n,
    ...
    class_rows: 1130n, class_columns: 1137n, class_degree: 3n,
    class_kernel_columns: 7n, class_presentation_columns: 2n,
