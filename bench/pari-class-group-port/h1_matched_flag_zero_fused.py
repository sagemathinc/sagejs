"""Single-call matched flag-zero H1 graph.

Generated mechanically from the authenticated live-H1 and compact p192 root
signatures. The timed function performs no evidence serialization and never imports
the stronger exact-unit retry suffix.
...
from .h1_matched_flag_zero import pari_h1_compact_flag_zero_root
from .unified_live_h1_root import pari_unified_live_h1_root


@native
def pari_fused_h1_matched_flag_zero_root(
    ...
    """Run live H1 and exactly one compact p192 `getfu` in one native call."""
    for index in range(12):
        root_state[index] = 0
    live_status = pari_unified_live_h1_root(
        matrix,
        ideal,
        n,
        precision,
    ...
    if live_status != 0:
        ...
        return live_status
    return pari_h1_compact_flag_zero_root(
        unified_state,
        bridge_state,
        hnf_state,
        hnf_assembly_state,
