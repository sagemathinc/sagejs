...
from sagejs.native import IntegerBuffer, UInt64Buffer, native
from .bounded_get_fs_small import bounded_pari_get_fs_small
from .bounded_flx_small_factor import bounded_pari_flx_small_factor_workspace_size
from .f2x_small_factor import pari_f2x_small_factor_workspace_size


@native
def bounded_pari_prime_degree_catalog(
    ...
    factors = 0
    for i in range(prime_count):
        result = bounded_pari_get_fs_small(
            coefficients,
            degree,
            equation_index,
            primes[i],
