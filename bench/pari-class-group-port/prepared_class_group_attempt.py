"""Prepared PARI class-group attempt in one source-transparent native call.

Copyright (C) The PARI group. GPL-2.0-or-later, without warranty.
Initial relations, collection, logarithms, HNF, regulator acceptance and
invariant-only Smith output share resident owners. Prepared nf/factor-base,
...
@native
def pari_prepared_class_group_attempt(
    ...
    attempt_state is [phase, action, invariant count, published]. Phase 1
    denotes relation/HNF work, 2 regulator acceptance, 3 Smith output, and
    4 a terminal outcome. Exceptions leave a partial phase and reject reuse;
    terminal repeats do no work. Nonzero actions are not completed groups:
    -100 requests more relations at the post-HNF dimension gate; acceptance
    1..6 retain their existing retry meanings; negative arithmetic/frontier
    statuses retain their originating phase in the stage-specific owners.

    Zero means PARI's experimental candidate acceptance, not completeness or
    ...
    attempt_state[3] = 0
    attempt_state[0] = 1
    action = pari_connected_relation_hnf(
        matrix,
        ideal,
        n,
        precision,
