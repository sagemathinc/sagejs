...
def pari_regulator_pivots(
    ...
    disjoint. Inexact entries retain a guard word inside the reviewed
    154,112-bit divrr corridor. First-pass validation is extra
