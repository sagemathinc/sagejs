"""PARI 2.17.4 det2 and real-domain det_simple_gauss, dimensions 0..5.
...
@native
def pari_row23_regulator_determinant(
    ...
    """
    if n < 0 or n > 5:
        raise ValueError("det2 prototype dimension outside 0..5")
