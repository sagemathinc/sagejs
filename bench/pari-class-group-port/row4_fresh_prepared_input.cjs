...
// Host allocation for a genuinely fresh row-4 prepared computation.  Every
// capacity is derived from the prepared degree and the PARI factor-base target;
// no retained relation, W0 owner, or terminal answer supplies storage.
