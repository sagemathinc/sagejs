...
const readiness = require("./row6_phase6_prepared_timing_readiness.cjs");
...
const DEFAULT_PREPARED = "/scratch/sagejs-pari-fresh-prepared-corpus-v1/" +
  "prepared-row-06-45c52f204312ae6a4ea5ffef98319154578f047238bb48948daa88760ff94f45.json";
...
async function main() {
  ...
  process.stdout.write(`${JSON.stringify({
    schema: "sagejs.pari-class-group/row6-phase6-timing-readiness-check-v1",
