"""Generated authenticated prepared-input row-23 class/unit root."""

from sagejs.native import Float64Buffer, Int64Buffer, IntegerBuffer, native
from .row23_phase6_prepared_factor_root import pari_row23_phase6_prepared_factor_root
from .row23_phase6_aggregate_root import pari_row23_phase6_aggregate_root


@native
def pari_row23_phase6_prepared_root(
    ...
    factor_index_ideals: IntegerBuffer,
    factor_index_norms: IntegerBuffer,
    factor_index_state: IntegerBuffer,
...
__all__ = ["pari_row23_phase6_prepared_root"]
