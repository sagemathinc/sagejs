"""Diagnostic arena wrapper; identical prepared PARI computation.

No retry is permitted after mutation. Caller must discard failed outputs.
"""
...
@native
def pari_prepared_class_group_arena(
    ...
    with NativeExactArena(0, temporary_limit) as arena:
