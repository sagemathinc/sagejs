...
from .row23_regulator_multiple import pari_row23_regulator_multiple
from .row23_regulator_reconstruction import pari_row23_regulator_reconstruction
from .regulator_scalar import pari_validate_regulator_values


@native
def pari_row23_regulator_acceptance(
    logs: IntegerBuffer,
    rows: int,
    columns: int,
    degree: int,
...
@native
def pari_row23_regulator_acceptance_multiple(
    logs: IntegerBuffer,
    rows: int,
    columns: int,
    degree: int,
    ...
    status = pari_row23_regulator_multiple(
        logs,
        rows,
        columns,
        degree,
...
@native
def pari_row23_regulator_acceptance_finish(
    rows: int,
    columns: int,
    multiple_state: Int64Buffer,
    multiple: IntegerBuffer,
    ...
    acceptance_state[2] = -1
    status = pari_row23_regulator_reconstruction(
        coordinates,
        rows - 1,
        columns,
        multiple,
