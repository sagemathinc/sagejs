...
function validateManifest(manifestPath = MANIFEST_PATH) {
  ...
  const expectedPins = {
    ...
    qualificationManifest: ["class-unit-qualification-manifest.json", "fb3b5d16a03ab348b7d8f495dddb6d2716dda45c0486213246298222a9a3cb90"],
    qualificationRunner: ["run_class_unit_qualification.cjs", "8cea73a89f02716cada918aa790330b72db47c166402704498f6dafc2965e49e"],
