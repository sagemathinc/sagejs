...
function pythonSource() {
  return [
    ...
    "    instrument(analysis_resource, '_native_field_analysis_projection_from_polynomial_bound', 'native_field_analysis_projection')",
    "    instrument(engine, '_order_from_basis', 'order_materialization')",
    "    instrument(certification, 'certify_global_order', 'global_certification')",
