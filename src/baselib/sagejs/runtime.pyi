...
def bind_machine_extension_context(
    parent: Any,
    degree: int,
    prime: int,
    source_modulus_coefficients: Any,
    machine_modulus_coefficients: Any,
) -> bool: ...
def brand_machine_field_element(value: Any) -> Any: ...
def machine_extension_context_matches(parent: Any, modulus_coefficients: Any) -> bool: ...
def named_tuple(
    values: list[Any],
    type_name: str,
...
def register_native_layout(cls: Any, subclassable: bool = True) -> None: ...
def validate_class_bases(bases: Any, check_layouts: bool = True) -> None: ...
