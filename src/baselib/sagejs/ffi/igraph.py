...
__sagejs_ffi_declaration__ = (
    "igraph@14837065f94e1b66695f9efc56e12572e0e76788ba58a10e9be468828f01b177"
)
...
class IGraph:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:igraph@14837065f94e1b66695f9efc56e12572e0e76788ba58a10e9be468828f01b177:graph",
        )
...
class IGraphEdges:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:igraph@14837065f94e1b66695f9efc56e12572e0e76788ba58a10e9be468828f01b177:edges",
        )
