...
__sagejs_ffi_declaration__ = (
    "igraph@22ee0d4dc5256668b29251ef8009275ff1251b09e26523969a3dd387c55630a4"
)
...
class IGraph:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:igraph@22ee0d4dc5256668b29251ef8009275ff1251b09e26523969a3dd387c55630a4:graph",
        )
...
class IGraphEdges:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:igraph@22ee0d4dc5256668b29251ef8009275ff1251b09e26523969a3dd387c55630a4:edges",
        )
