...
def _inverse_mod(value: Any, modulus: Any) -> Any:
    ...
    while remainder != 0:
        ...
        temporary = runtime.integer_bigint(
...
class PAdicElement(sage.Element):
    ...
    def __init__(
        ...
        if (
            parent._kind == 'Zp'
            and numerator_valuation - denominator_valuation < 0
        ):
    ...
    def __repr__(self) -> str:
        ...
        inverse = runtime.integer_bigint(
            _inverse_mod(denominator_residue, modulus))
...
class PAdicParent(sage.Parent):
    ...
    def __init__(
        ...
        self._name = (
            str(prime) + '-adic ' + noun
            + ' with capped relative precision ' + str(precision)
        )
...
def _p_adic_parent(
    ...
    if parent is runtime.undefined:
        parent = PAdicParent(
            selected_prime, selected_precision, kind)
...
runtime.register_doc(
    ...
    Qp,
    {
        ...
        'provenance': [
            {
                ...
                'url': (
                    'https://doc.sagemath.org/html/en/reference/padics/'
                ),
        ...
        'implementation': {
            'algorithm': (
                'modular inversion followed by base-p digit extraction'
            ),
        },
        'limitations': [
