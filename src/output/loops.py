...
from output.statements import print_await_expression
from output.loop_common import (
    loop_can_catch_interrupt,
    prepare_loop_else,
    print_interrupt_check,
    print_loop_else,
    print_unpack_pattern,
    unpack_tuple,
)
from output.optimizer.dispatcher import print_optimized_for_in
...
def print_for_in(self, output):
    if self.optimization_region:
        return print_optimized_for_in(self, output)
    prepare_loop_else(self, output)
