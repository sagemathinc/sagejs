...
__sagejs_ffi_declaration__ = (
    "flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4"
)
...
class FmpzMatrix:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:fmpz_matrix",
        )
...
class FmpqMatrix:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:fmpq_matrix",
        )
...
class FmpqValue:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:fmpq_value",
        )
    ...
    def from_bytes(cls, source: Any) -> FlintByteRegion:
        ...
        return cls(
            _runtime.ffi_resource_create(
                ...
                "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:byte_region",
...
class FmpzPolynomial:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:fmpz_polynomial",
        )
...
class FmpqPolynomial:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:fmpq_polynomial",
        )
...
class ExactPolynomialFactorization:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:exact_polynomial_factorization",
        )
...
class FmpzPolynomialDivisionResult:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:fmpz_polynomial_division_result",
        )
...
class FmpqPolynomialDivisionResult:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:fmpq_polynomial_division_result",
        )
...
class DirichletGroup:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:flint@51338fba598191bb4808a2d7008b3b5e44f4bbd3e910910658d80f82f35e9db4:dirichlet_group",
        )
