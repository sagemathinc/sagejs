...
__sagejs_ffi_declaration__ = (
    "m4ri@5847bc810e7a478d9a814935b9cc665b2178ca5ada07a9e32f510630ba6bb5bd"
)
...
class M4riMatrix:
    ...
    def _ffi_borrow(self) -> Any:
        return _runtime.ffi_resource_borrow(
            self._token,
            "resource:m4ri@5847bc810e7a478d9a814935b9cc665b2178ca5ada07a9e32f510630ba6bb5bd:matrix",
        )
    ...
    def from_bytes(cls, source: Any) -> M4riByteRegion:
        ...
        return cls(
            _runtime.ffi_resource_create(
                ...
                "resource:m4ri@5847bc810e7a478d9a814935b9cc665b2178ca5ada07a9e32f510630ba6bb5bd:byte_region",
...
def matrix_swap_rows(matrix: M4riMatrix, first: int, second: int) -> bool:
    """Call declared m4ri:matrix_swap_rows."""
    return _runtime.ffi_call(
        __sagejs_ffi_declaration__ + ":matrix_swap_rows",
        "@sagemath/sagejs-m4ri",
        ...
        ["status", [1], None],
        "ValueError",
        "M4RI matrix row index is out of range",
        [],
    )


def matrix_swap_columns(matrix: M4riMatrix, first: int, second: int) -> bool:
    """Call declared m4ri:matrix_swap_columns."""
    return _runtime.ffi_call(
        __sagejs_ffi_declaration__ + ":matrix_swap_columns",
        "@sagemath/sagejs-m4ri",
        ...
        ["status", [1], None],
        "ValueError",
        "M4RI matrix column index is out of range",
        [],
    )
...
def matrix_select_rows(
    source: M4riMatrix, indices: list[int], count: int
) -> M4riMatrix:
    """Call declared m4ri:matrix_select_rows."""
    return M4riMatrix(
        _runtime.ffi_resource_create(
...
def matrix_prefix_rows(source: M4riMatrix, count: int) -> M4riMatrix:
    """Call declared m4ri:matrix_prefix_rows."""
    return M4riMatrix(
        _runtime.ffi_resource_create(
            ...
            "zero_is_error",
            "ValueError",
            "M4RI matrix row-prefix count is invalid",
        )
    )
