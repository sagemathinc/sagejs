...
def word_prime_krylov_minimal_polynomial(
    ...
    Matrix-vector products reduce after eight terms for moduli below `2^30`.
    Larger word primes reduce every product so unsigned accumulation cannot
    wrap near `2^64`.
    """
