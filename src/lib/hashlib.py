...
_BLOCK_SIZES = {
    ...
    'sha384': 128, 'sha512': 128, 'blake2b': 128, 'blake2s': 64,
    'sha3_224': 144, 'sha3_256': 136, 'sha3_384': 104,
    'sha3_512': 72, 'shake_128': 168, 'shake_256': 136,
}
...
runtime.reflect.set(
    runtime.reflect.get(runtime.modules, 'hashlib'), 'new', _new)
