...
const sharedNames = ["ρσ_native_map_iterator", "ρσ_machine_extension_method_matches", "ρσ_copy_method_metadata", "ρσ_append_fn", "ρσ_native_method_adapter", "ρσ_unbound_method_adapter",
