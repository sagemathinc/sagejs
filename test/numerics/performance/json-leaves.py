...
finite_checks = []
# Patch the actual dependency used by the function under test. Existing browser
# precompiled modules may hold a different math module from the session import;
# that separate module-identity defect must not make this count a false oracle.
original_isfinite = _json.math.isfinite
...
_json.math.isfinite = counted_isfinite
try:
    ...
    _json.math.isfinite = original_isfinite
