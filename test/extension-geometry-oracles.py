...
oracle_stage = globals().get("_extension_geometry_oracle_stage")
assert oracle_stage in (None, "radical", "joined", "nonsplit", "points")
...
for case in _extension_geometry_cases:
    ...
    x, y = R.gens()
    if oracle_stage in (None, "radical"):
