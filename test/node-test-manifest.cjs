...
const unit = [
  ...
  "test/wasm-group-computation.cjs",
...
const integration = [
  ...
  "test/number-field-element-valuation-kernel.cjs",
  ...
  "test/hyperelliptic-bsd-pipeline.cjs",
  "test/hyperelliptic-bsd-public.cjs",
  "test/hyperelliptic-bsd-saturation-adapter.cjs",
  "test/hyperelliptic-bsd-saturation.cjs",
  "test/hyperelliptic-analytic-performance.cjs",
  "test/hyperelliptic-finite-jacobian-magma-contract.cjs",
  ...
  "test/hyperelliptic-local-data-performance.cjs",
