...
const integration = [
  ...
  "test/hyperelliptic-bsd-oracles/verify.mjs",
  "test/hyperelliptic-bsd-oracles/verify-magma-genus3-height.mjs",
  "test/hyperelliptic-bsd-oracles/verify-genus3-height-radius6.mjs",
