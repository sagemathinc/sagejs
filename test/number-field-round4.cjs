  ...
  try {
    const result = await session.evaluate(
      [
        ...
        `assert metrics['modular_characteristic_batch_calls'] == ${record.characteristic_polynomial_metrics.modular_characteristic.batch_calls}`,
        `assert metrics['modular_characteristic_batch_primes'] == ${record.characteristic_polynomial_metrics.modular_characteristic.batch_primes}`,
        `assert metrics['modular_characteristic_reconstruction_attempts'] == ${record.characteristic_polynomial_metrics.modular_characteristic.reconstruction_attempts}`,
