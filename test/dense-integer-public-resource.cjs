...
(async () => {
  ...
  try {
    ...
    // Two-worker Linux validation has measured 354.5 ms, and Windows CI
    // measured 367.8 ms, versus about 196 ms in isolation. Give process-cold
    // initialization realistic host contention headroom. Warm the generated
    ...
    const randomLimit =
      process.platform === "darwin" && process.arch === "arm64" ? 700 : 450;
