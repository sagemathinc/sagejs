...
function sourceBlock(source){if(!source)return null;const details=node("details","source");details.id="source";details.append(node("summary","",`Browse relevant source · ${source.path}:${source.line}`));const pre=node("pre","line-numbers"),code=node("code","",source.excerpt.text);pre.dataset.start=String(source.excerpt.start_line);pre.append(code);highlightCode(code,"python");details.append(pre);return details}
